...
# ydb yql -s 'DROP TABLE ja; DROP TABLE jb; DROP TABLE jc;'
...
export YDB_CONNECTION_STRING=grpcs://zeit-1:2135/Domain0/zodak
...
java -classpath ydb-jdbc-driver-shaded-2.2.1.jar:ydb-join-test-1.0-SNAPSHOT.jar tech.ydb.samples.jointest.YdbJoinTest
